    ...
    return (
        ...
        >
            {url ? (
                ...
                <div
                    className={cn(
                        "absolute inset-0 flex flex-col justify-center items-center text-center bg-linear-to-br from-muted to-muted-foreground/20",
                        padding,
                    )}
                >
                    <p
                        className={cn(
                            "font-semibold text-foreground leading-tight line-clamp-3 text-center",
                            text,
                        )}
                    >
                        {title}
            ...
            <div className="absolute inset-0 rounded-lg pointer-events-none shadow-[inset_2px_0_6px_rgba(0,0,0,0.2),inset_-1px_0_3px_rgba(0,0,0,0.1)]" />
        </div>
    )
}
